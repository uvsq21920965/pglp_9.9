...
public class DrawingApp {
  ...
  public void run() {
    ...
    System.out.println(" celà va créer un cercle nommée c1 son centre (1,1) son rayon : 2 dans le  groupe: g1 qui sera cré automatiquement s'il n'existe pas");
    ...
    System.out.println(" celà va créer un carré nommé ca1 à la position (1,5) avec son coté:2 dans le groupe: g1 qui sera cré automatiquement s'il n'existe pas");
    ...
    System.out.println(" celà va créer un rectangle nommé re1 à la position (1,5), sa longueur:6 ,sa largeur:2 dans le groupe: g1 qui sera cré automatiquement s'il n'existe pas");
	...
	System.out.println(" celà va créer un triangle nommé re1 à la position (1,5), sa base:4, sa hauteur:5 dans le groupe: g1 qui sera cré automatiquement s'il n'existe pas");
    ...
    System.out.println(" pour afficher un tous les composants du groupe la commande sera : affichegroupe g1");
    System.out.println(" pour sauvegader un groupe dans le sgbd la commande sera : save g1");
	System.out.println(" pour charger un groupe déja sauvegarder à partir du sgbd la commande sera : load g1");
    System.out.println("-----------------------------------------------------------------------------------");
